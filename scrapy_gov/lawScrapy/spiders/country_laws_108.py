...
# scrapy crawl country_laws_108


class CountryLaw108Spider(scrapy.Spider):
    name = 'country_laws_108'
    ...
    def start_requests(self):
        ...
        with open("lawScrapy/spiders/c108.json", 'r', encoding="utf-8") as f:
            data = json.load(f)
    ...
    def parse_article(self, response):
        ...
        item["legalCategory"] = "深交所-本所业务指南-固收类"

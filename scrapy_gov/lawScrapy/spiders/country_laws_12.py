...
# scrapy crawl country_laws_12


class CountryLaw12Spider(scrapy.Spider):
    name = 'country_laws_12'
    allowed_domains = ['ndrc.gov.cn']
    url_list = []
    count = 0

    def start_requests(self):
        base = 'https://www.ndrc.gov.cn/xxgk/zcfb/ghwb/index_{}.html'
        start_url = ['https://www.ndrc.gov.cn/xxgk/zcfb/ghwb/index.html']

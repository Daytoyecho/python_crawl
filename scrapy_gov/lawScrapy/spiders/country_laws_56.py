...
# scrapy crawl country_laws_56


class CountryLaw56Spider(scrapy.Spider):
    name = 'country_laws_56'
    ...
    def start_requests(self):
        BASEURL = 'http://www.mofcom.gov.cn/article/zhengcejd/bq/?{}'
        start_url = ['http://www.mofcom.gov.cn/article/zhengcejd/bq/']
    ...
    def parse_article(self, response):
        ...
        item["legalCategory"] = "商务部-政策解读投资合作"

...
# scrapy crawl province_laws_27


class ProvinceLaw27Spider(scrapy.Spider):
    name = 'province_laws_27'
    allowed_domains = ['sz.gov.cn']
    url_list = []
    count = 0

    def start_requests(self):
        base = 'http://jr.sz.gov.cn/gkmlpt/api/all/2825?page={}&sid=755031'
        start_url = []
        for i in range(1, 9):
    ...
    def parse_article(self, response):
        ...
        item["legalCategory"] = "深圳市地方金融监督管理局-通知公告"

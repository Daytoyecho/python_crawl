...
# scrapy crawl country_laws_57


class CountryLaw57Spider(scrapy.Spider):
    name = 'country_laws_57'
    ...
    def start_requests(self):
        BASEURL = 'http://www.mofcom.gov.cn/article/zhengcejd/bl/?{}'
        start_url = ['http://www.mofcom.gov.cn/article/zhengcejd/bl/']
    ...
    def parse_article(self, response):
        ...
        item["legalCategory"] = "商务部-政策解读对外贸易"

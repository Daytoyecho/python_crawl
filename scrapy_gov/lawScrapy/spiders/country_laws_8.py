...
# scrapy crawl country_laws_8


class CountryLaw8Spider(scrapy.Spider):
    name = 'country_laws_8'
    ...
    def start_requests(self):
        base = 'https://www.ndrc.gov.cn/xxgk/zcfb/pifu/index_{}.html'
        start_url = ['https://www.ndrc.gov.cn/xxgk/zcfb/pifu/index.html']

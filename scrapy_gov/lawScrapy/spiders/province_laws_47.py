...
# scrapy crawl province_laws_47


class ProvinceLaw47Spider(scrapy.Spider):
    name = 'province_laws_47'
    allowed_domains = ['hangzhou.gov.cn']
    url_list = []
    count = 0

    def start_requests(self):
        start_url = "http://www.hangzhou.gov.cn/module/jpage/dataproxy.jsp?startrecord=1&endrecord=201&perpage=70"

        baseform = 'col=1&appid=1&webid=149&path=%2F&columnid=1229063387&sourceContentType=1&unitid=6793088&webname=%E6%9D%AD%E5%B7%9E%E5%B8%82%E4%BA%BA%E6%B0%91%E6%94%BF%E5%BA%9C%E9%97%A8%E6%88%B7%E7%BD%91%E7%AB%99&permissiontype=0'
        header = deepcopy(tools.header)
        header['Origin'] = 'http://www.hangzhou.gov.cn'
        header['Referer'] = 'http://www.hangzhou.gov.cn/col/col1229063387/index.html?uid=6793088&pageNum=1'
        header['Content-Type'] = 'application/x-www-form-urlencoded; charset=UTF-8'
        res = appbk_sql.mysql_com('SELECT legalUrl FROM `law`; ')
        self.url_list = [item['legalUrl'] for item in res]
        yield scrapy.Request(start_url, body=baseform, method='POST', callback=self.parse_dictionary, dont_filter=True, headers=header)
    ...
    def parse_article(self, response):
        ...
        item["legalCategory"] = "杭州市政府-市政府文件"

...
# scrapy crawl country_laws_122


class CountryLaw122Spider(scrapy.Spider):
    name = 'country_laws_122'
...
#-------------------------------------------------------------#
    ...
    def start_requests(self):
        ...
        # 单页
        start_url = ['http://www.chinaclear.cn/zdjs/tzgg/branch_tlist.shtml']
    ...
    def parse_article(self, response):
        ...
        item["legalCategory"] = "中国结算-北京分公司通知公告"

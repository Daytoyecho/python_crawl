...
# scrapy crawl country_laws_11


class CountryLaw11Spider(scrapy.Spider):
    name = 'country_laws_11'
    allowed_domains = ['ndrc.gov.cn']
    url_list = []
    count = 0

    def start_requests(self):
        base = 'https://www.ndrc.gov.cn/xxgk/zcfb/tz/index_{}.html'
        start_url = ['https://www.ndrc.gov.cn/xxgk/zcfb/tz/index.html']

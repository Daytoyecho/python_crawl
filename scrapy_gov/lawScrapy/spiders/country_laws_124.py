...
# scrapy crawl country_laws_124


class CountryLaw124Spider(scrapy.Spider):
    name = 'country_laws_124'
...
#-------------------------------------------------------------#
    ...
    def start_requests(self):
        ...
        base = 'http://www.chinaclear.cn/zdjs/shtz/branch_tlist_{}.shtml'
        start_url = ['http://www.chinaclear.cn/zdjs/shtz/branch_tlist.shtml']
    ...
    def parse_article(self, response):
        ...
        item["legalCategory"] = "中国结算-上海分公司通知公告"
        #-------------------------------------------------------------#

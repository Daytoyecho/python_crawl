...
# scrapy crawl country_laws_62


class CountryLaw62Spider(scrapy.Spider):
    name = 'country_laws_62'
    ...
    def start_requests(self):
        BASEURL = 'http://www.mofcom.gov.cn/article/b/d/?{}'
        start_url = ['http://www.mofcom.gov.cn/article/b/d/']

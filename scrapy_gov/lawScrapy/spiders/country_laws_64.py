...
# scrapy crawl country_laws_64


class CountryLaw64Spider(scrapy.Spider):
    name = 'country_laws_64'
    ...
    def start_requests(self):
        BASEURL = 'http://www.mofcom.gov.cn/article/b/f/?{}'
        start_url = ['http://www.mofcom.gov.cn/article/b/f/']

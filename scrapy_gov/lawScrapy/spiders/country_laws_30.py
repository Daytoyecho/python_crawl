...
# scrapy crawl country_laws_30


class CountryLaw30Spider(scrapy.Spider):
    name = 'country_laws_30'
    ...
    def start_requests(self):
        start_url = ['http://www.most.gov.cn/xxgk/xinxifenlei/fdzdgknr/gjkjgh/',
                     "http://www.most.gov.cn/xxgk/xinxifenlei/fdzdgknr/gjkjgh/index_1.html",
                     "http://www.most.gov.cn/xxgk/xinxifenlei/fdzdgknr/gjkjgh/index_2.html",
                     "http://www.most.gov.cn/xxgk/xinxifenlei/fdzdgknr/gjkjgh/index_3.html"]
    ...
    def parse_dictionary(self, response):
        ...
        law_title = response.xpath('//ul[@id="data_list"]/li/a/@title').extract()
        law_time = response.xpath('//ul[@id="data_list"]/li/div[3]/text()').extract()
    ...
    def parse_article(self, response):
        ...
        item["legalCategory"] = "科学技术部-国家科技规划"

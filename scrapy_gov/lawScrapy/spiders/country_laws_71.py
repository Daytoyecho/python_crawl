...
# scrapy crawl country_laws_71


class CountryLaw71Spider(scrapy.Spider):
    name = 'country_laws_71'
    allowed_domains = ['pbc.gov.cn']
    url_list = []
    count = 0

    def start_requests(self):
        base = 'http://www.pbc.gov.cn/tiaofasi/144941/3581332/3b3662a6/index{}.html'
        start_url = ['http://www.pbc.gov.cn/tiaofasi/144941/3581332/3b3662a6/index1.html']
    ...
    def parse_article(self, response):
        ...
        item["legalCategory"] = "中国人民银行-主要有效规范性文件"

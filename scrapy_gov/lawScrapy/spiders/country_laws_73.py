...
# scrapy crawl country_laws_73


class CountryLaw73Spider(scrapy.Spider):
    name = 'country_laws_73'
    allowed_domains = ['pbc.gov.cn']
    url_list = []
    count = 0

    def start_requests(self):
        base = 'http://www.pbc.gov.cn/jinrongshichangsi/147160/147289/147301/22922/index{}.html'
        start_url = ['http://www.pbc.gov.cn/jinrongshichangsi/147160/147289/147301/22922/index1.html']
    ...
    def parse_article(self, response):
        ...
        item["legalCategory"] = "中国人民银行-信贷政策法规"

...
# scrapy crawl country_laws_59


class CountryLaw59Spider(scrapy.Spider):
    name = 'country_laws_59'
    ...
    def start_requests(self):
        BASEURL = 'http://www.mofcom.gov.cn/article/zhengcejd/bj/?{}'
        start_url = ['http://www.mofcom.gov.cn/article/zhengcejd/bj/']
    ...
    def parse_article(self, response):
        ...
        item["legalCategory"] = "商务部-政策解读综合商务"

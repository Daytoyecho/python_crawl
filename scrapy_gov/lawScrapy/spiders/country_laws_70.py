...
# scrapy crawl country_laws_70


class CountryLaw70Spider(scrapy.Spider):
    name = 'country_laws_70'
    allowed_domains = ['pbc.gov.cn']
    url_list = []
    count = 0

    def start_requests(self):
        base = 'http://www.pbc.gov.cn/tiaofasi/144941/144957/21892/index{}.html'
        start_url = ['http://www.pbc.gov.cn/tiaofasi/144941/144957/21892/index1.html']
    ...
    def parse_article(self, response):
        ...
        item["legalCategory"] = "中国人民银行-部门规章"

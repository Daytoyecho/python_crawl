...
# scrapy crawl country_laws_38


class CountryLaw38Spider(scrapy.Spider):
    name = 'country_laws_38'
    ...
    def start_requests(self):
        base = 'http://www.most.gov.cn/kjzc/gjkjzc/kjzjfw/index_{}.html'
        start_url = ['http://www.most.gov.cn/kjzc/gjkjzc/kjzjfw/']
    ...
    def parse_article(self, response):
        ...
        item["legalCategory"] = "科学技术部-国家科技政策科技中介服务"

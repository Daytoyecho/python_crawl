...
# scrapy crawl province_laws_90


class ProvinceLaw90Spider(scrapy.Spider):
    name = 'province_laws_90'
...
#-------------------------------------------------------------#
    ...
    def start_requests(self):
        ...
        start_url = ['http://jrjg.ln.gov.cn/zfxxgk_146759/fdzdgknr/lzyj/dfxfg/']
    ...
    def parse_article(self, response):
        ...
        item["legalCategory"] = "辽宁省地方金融监督管理局-地方性法规"

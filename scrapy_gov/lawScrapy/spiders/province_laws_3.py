...
# scrapy crawl province_laws_3


class ProvinceLaw3Spider(scrapy.Spider):
    name = 'province_laws_3'
    allowed_domains = ['beijing.gov.cn']
    url_list = []
    count = 0

    def start_requests(self):
        base1 = 'http://www.beijing.gov.cn/zhengce/zfwj/zfwj/szfl/index_{}.html'
        base2 = 'http://www.beijing.gov.cn/zhengce/zfwj/zfwj2016/szfl/index_{}.html'
        start_url = ['http://www.beijing.gov.cn/zhengce/zfwj/zfwj/szfl/', 'http://www.beijing.gov.cn/zhengce/zfwj/zfwj2016/szfl/']

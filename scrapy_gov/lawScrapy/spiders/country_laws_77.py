...
# scrapy crawl country_laws_77


class CountryLaw77Spider(scrapy.Spider):
    name = 'country_laws_77'
    ...
    def start_requests(self):
        ...
        base = 'https://www.mee.gov.cn/zcwj/bgtwj/wj/index_{}.shtml'
        start_url = ['https://www.mee.gov.cn/zcwj/bgtwj/wj/index.shtml']
    ...
    def parse_article(self, response):
        ...
        item["legalCategory"] = "中华人民共和国生态环境部-政策文件-办公厅文件-文件"

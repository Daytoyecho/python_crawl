...
# scrapy crawl country_laws_34


class CountryLaw34Spider(scrapy.Spider):
    name = 'country_laws_34'
    ...
    def start_requests(self):
        base = 'http://www.most.gov.cn/kjzc/gjkjzc/jcyjykyjd/index_{}.html'
        start_url = ['http://www.most.gov.cn/kjzc/gjkjzc/jcyjykyjd/']
    ...
    def parse_article(self, response):
        ...
        item["legalCategory"] = "科学技术部-国家科技政策基础研究与科研基地"

...
# scrapy crawl country_laws_9


class CountryLaw9Spider(scrapy.Spider):
    name = 'country_laws_9'
    ...
    def start_requests(self):
        base = 'https://www.ndrc.gov.cn/xxgk/zcfb/qt/index_{}.html'
        start_url = ['https://www.ndrc.gov.cn/xxgk/zcfb/qt/index.html']

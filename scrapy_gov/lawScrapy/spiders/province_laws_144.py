...
# scrapy crawl province_laws_144


class ProvinceLaw144Spider(scrapy.Spider):
    name = 'province_laws_144'
    ...
    def start_requests(self):
        ...
        base = "http://www.guizhou.gov.cn/zwgk/zcfg/swygwj/index_{}.html"
        start_url = ['http://www.guizhou.gov.cn/zwgk/zcfg/swygwj/index.html']
    ...
    def parse_article(self, response):
        ...
        item["legalCategory"] = "贵州省政府-省委有关文件"

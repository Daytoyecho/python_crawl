...
# scrapy crawl country_laws_42


class CountryLaw42Spider(scrapy.Spider):
    name = 'country_laws_42'
    ...
    def start_requests(self):
        start_url = ['http://www.most.gov.cn/kjzc/gjkjzc/kxjspj/']
    ...
    def parse_article(self, response):
        ...
        item["legalCategory"] = "科学技术部-国家科技政策科学技术普及"

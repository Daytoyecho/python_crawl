...
# scrapy crawl country_laws_53


class CountryLaw53Spider(scrapy.Spider):
    name = 'country_laws_53'
    allowed_domains = ['mof.gov.cn']
    url_list = []
    count = 0

    def start_requests(self):
        BASEURL = 'http://www.mof.gov.cn/zhengwuxinxi/caizhengxinwen/index_{}.htm'
        start_url = ['http://www.mof.gov.cn/zhengwuxinxi/caizhengxinwen/index.htm']
    ...
    def parse_dictionary(self, response):
        ...
        data_list = response.xpath('//div[@class="xwfb_listerji"]//li')

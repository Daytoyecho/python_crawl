...
# scrapy crawl country_laws_83


class CountryLaw83Spider(scrapy.Spider):
    name = 'country_laws_83'
    ...
    def start_requests(self):
        ...
        base = 'https://www.mee.gov.cn/zcwj/bwj/wj/index_{}.shtml'
        start_url = ['https://www.mee.gov.cn/zcwj/bwj/wj/index.shtml']
    ...
    def parse_article(self, response):
        ...
        item["legalCategory"] = "中华人民共和国生态环境部-政策文件-部文件-文件"

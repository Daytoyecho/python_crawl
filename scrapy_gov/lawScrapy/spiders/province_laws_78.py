...
# scrapy crawl province_laws_78


class ProvinceLaw78Spider(scrapy.Spider):
    name = 'province_laws_78'
    ...
    def start_requests(self):
        ...
        base = "http://www.hubei.gov.cn/zfwj/list2_{}.shtml"
        start_url = ["http://www.hubei.gov.cn/zfwj/list2.shtml"]
        ...
        for url in start_url:
            ...
            for i in range(len(data_list)):
                ...
                if tmpurl not in self.url_list:
                    yield scrapy.Request("http://jrgz.tj.gov.cn/zwgk/jrzc_1/jrjzc/", self.parse_article, meta={"url": tmpurl, "title": law_title, "time": law_time}, dont_filter=True, headers=tools.header)

    def parse_article(self, response):
        item = LawscrapyItem()
        item["legalUrl"] = response.meta['url']
        item["legalProvince"] = "湖北省"
        item["legalCategory"] = "湖北省政府-其他文件"

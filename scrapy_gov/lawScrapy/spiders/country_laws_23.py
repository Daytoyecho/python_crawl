...
# scrapy crawl country_laws_23


class CountryLaw23Spider(scrapy.Spider):
    name = 'country_laws_23'
    ...
    def start_requests(self):
        start_url = ['http://www.most.gov.cn/satp/kjzc/kjjdycxjs/']
    ...
    def parse_article(self, response):
        ...
        item["legalCategory"] = "科学技术部-科技政策科技监督与诚信建设"

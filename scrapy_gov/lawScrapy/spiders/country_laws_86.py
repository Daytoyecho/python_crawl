...
# scrapy crawl country_laws_86


class CountryLaw86Spider(scrapy.Spider):
    name = 'country_laws_86'
    ...
    def start_requests(self):
        ...
        base = 'https://www.mee.gov.cn/zcwj/haqjwj/wj/index_{}.shtml'
        start_url = ['https://www.mee.gov.cn/zcwj/haqjwj/wj/index.shtml']
    ...
    def parse_article(self, response):
        ...
        item["legalCategory"] = "中华人民共和国生态环境部-政策文件-核安全局文件-文件"

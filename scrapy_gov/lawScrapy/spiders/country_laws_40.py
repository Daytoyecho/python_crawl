...
# scrapy crawl country_laws_40


class CountryLaw40Spider(scrapy.Spider):
    name = 'country_laws_40'
    ...
    def start_requests(self):
        base = 'http://www.most.gov.cn/kjzc/gjkjzc/kjjryss/index_{}.html'
        start_url = ['http://www.most.gov.cn/kjzc/gjkjzc/kjjryss/']
    ...
    def parse_article(self, response):
        ...
        item["legalCategory"] = "科学技术部-国家科技政策科技金融与税收"

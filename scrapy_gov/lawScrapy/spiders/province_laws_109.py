...
# scrapy crawl province_laws_109


class ProvinceLaw109Spider(scrapy.Spider):
    name = 'province_laws_109'
    ...
    def start_requests(self):
        ...
        base = "http://www.xa.gov.cn/gk/zcfg/zfl/{}.html"
        start_url = ['http://www.xa.gov.cn/gk/zcfg/zfl/1.html']

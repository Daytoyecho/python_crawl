...
# scrapy crawl country_laws_66


class CountryLaw66Spider(scrapy.Spider):
    name = 'country_laws_66'
    ...
    def start_requests(self):
        BASEURL = 'http://www.mofcom.gov.cn/article/b/xxfb/?{}'
        start_url = ['http://www.mofcom.gov.cn/article/b/xxfb/']

...
# scrapy crawl province_laws_102_2


class ProvinceLaw102Spider(scrapy.Spider):
    name = 'province_laws_102_2'
    ...
    def parse_article(self, response):
        ...
        if tools.isWeb(response.url):
            ...
            content = response.xpath('//div[@class="content_p p10"]').extract_first()
            fujian = response.xpath('//div[@class="content_p p10"]//a/@href').extract()
            fujian_name = response.xpath('//div[@class="content_p p10"]//a[@href]').xpath('string(.)').extract()

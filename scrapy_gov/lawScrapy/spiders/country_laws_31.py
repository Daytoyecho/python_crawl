...
# scrapy crawl country_laws_31


class CountryLaw31Spider(scrapy.Spider):
    name = 'country_laws_31'
    ...
    def start_requests(self):
        base = 'http://www.most.gov.cn/tztg/index_{}.html'
        start_url = ['http://www.most.gov.cn/tztg/']
    ...
    def parse_dictionary(self, response):
        ...
        law_title = response.xpath('//div[@class="list-main"]/ul/li/a/@title').extract()

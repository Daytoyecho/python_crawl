...
# scrapy crawl province_laws_111


class ProvinceLaw111Spider(scrapy.Spider):
    name = 'province_laws_111'
    ...
    def start_requests(self):
        ...
        base = "http://www.xa.gov.cn/gk/zcfg/szf/list/{}.html"
        start_url = []

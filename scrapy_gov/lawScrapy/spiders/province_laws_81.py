...
# scrapy crawl province_laws_81


class ProvinceLaw81Spider(scrapy.Spider):
    name = 'province_laws_81'
    allowed_domains = ['wuhan.gov.cn']
    url_list = []
    count = 0

    def start_requests(self):
        base = "http://www.wuhan.gov.cn/zwgk/xxgk/zfwj/gfxwj/index_{}.shtml"
        start_url = ["http://www.wuhan.gov.cn/zwgk/xxgk/zfwj/gfxwj/index.shtml"]
    ...
    def parse_article(self, response):
        ...
        item["legalCategory"] = "武汉市政府-规范性文件"

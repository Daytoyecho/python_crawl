...
# scrapy crawl country_laws_25


class CountryLaw25Spider(scrapy.Spider):
    name = 'country_laws_25'
    ...
    def start_requests(self):
        base = 'http://www.most.gov.cn/satp/kjzcjd/index_{}.html'
        start_url = ['http://www.most.gov.cn/satp/kjzcjd/']
    ...
    def parse_article(self, response):
        ...
        item["legalCategory"] = "科学技术部-科技政策解读"
        ...
        if tools.isWeb(response.url):
            ...
            if not content:
                ...
                fujian = response.xpath('//div[@id="p-detail"]//a/@href').extract()
                fujian_name = response.xpath('//div[@id="p-detail"]//a[@href]').xpath('string(.)').extract()

...
class ProvinceLaw159_1Spider(scrapy.Spider):
    name = 'province_laws_159_1'
    ...
    def start_requests(self):
        ...
        base = "http://www.yinchuan.gov.cn/xxgk/zcwj/qtzfwj/szfbwj/szfzxwj_{}.html"
        start_url = ['http://www.yinchuan.gov.cn/xxgk/zcwj/qtzfwj/szfbwj/']
        for i in range(1, 10):

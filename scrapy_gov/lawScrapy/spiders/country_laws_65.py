...
# scrapy crawl country_laws_65


class CountryLaw65Spider(scrapy.Spider):
    name = 'country_laws_65'
    ...
    def start_requests(self):
        BASEURL = 'http://www.mofcom.gov.cn/article/b/bf/?{}'
        start_url = ['http://www.mofcom.gov.cn/article/b/bf/']
    ...
    def parse_article(self, response):
        ...
        item["legalCategory"] = "商务部-国外经济技术合作"

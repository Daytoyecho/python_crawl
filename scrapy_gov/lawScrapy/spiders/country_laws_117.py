...
# scrapy crawl country_laws_117


class CountryLaw117Spider(scrapy.Spider):
    name = 'country_laws_117'
...
#-------------------------------------------------------------#
    ...
    def start_requests(self):
        ...
        # 单页
        start_url = ['http://www.chinaclear.cn/zdjs/wywtz/service_flist.shtml']
    ...
    def parse_article(self, response):
        ...
        item["legalCategory"] = "中国结算-服务支持-业务通知"
        #-------------------------------------------------------------#

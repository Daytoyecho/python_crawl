...
# scrapy crawl country_laws_110


class CountryLaw110Spider(scrapy.Spider):
    name = 'country_laws_110'
    ...
    def start_requests(self):
        ...
        with open("lawScrapy/spiders/c110.json", 'r', encoding="utf-8") as f:
            data = json.load(f)
    ...
    def parse_article(self, response):
        ...
        item["legalCategory"] = "深交所-本所业务指南-基础设施REITs类"

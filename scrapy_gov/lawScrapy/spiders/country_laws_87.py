...
# scrapy crawl country_laws_87


class CountryLaw87Spider(scrapy.Spider):
    name = 'country_laws_87'
    ...
    def start_requests(self):
        ...
        base = 'https://www.mee.gov.cn/zcwj/haqjwj/han/index_{}.shtml'
        start_url = ['https://www.mee.gov.cn/zcwj/haqjwj/han/index.shtml']
    ...
    def parse_article(self, response):
        ...
        item["legalCategory"] = "中华人民共和国生态环境部-政策文件-核安全局文件-函"

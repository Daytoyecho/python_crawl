...
# scrapy crawl country_laws_61


class CountryLaw61Spider(scrapy.Spider):
    name = 'country_laws_61'
    ...
    def start_requests(self):
        BASEURL = 'http://www.mofcom.gov.cn/article/b/fwzl/?{}'
        start_url = ['http://www.mofcom.gov.cn/article/b/fwzl/']

...
# scrapy crawl country_laws_109


class CountryLaw109Spider(scrapy.Spider):
    name = 'country_laws_109'
    ...
    def start_requests(self):
        ...
        with open("lawScrapy/spiders/c109.json", 'r', encoding="utf-8") as f:
            data = json.load(f)
    ...
    def parse_article(self, response):
        ...
        item["legalCategory"] = "深交所-本所业务指南-基金类"

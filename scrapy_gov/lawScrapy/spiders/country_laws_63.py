...
# scrapy crawl country_laws_63


class CountryLaw63Spider(scrapy.Spider):
    name = 'country_laws_63'
    ...
    def start_requests(self):
        BASEURL = 'http://www.mofcom.gov.cn/article/b/e/?{}'
        start_url = ['http://www.mofcom.gov.cn/article/b/e/']

...
# scrapy crawl province_laws_116


class ProvinceLaw116Spider(scrapy.Spider):
    name = 'province_laws_116'
    ...
    def start_requests(self):
        ...
        base = "http://www.xa.gov.cn/gk/zcfg/zcjd/list/{}.html"
        start_url = []
    ...
    def parse_dictionary(self, response):
        ...
        law_title = response.xpath('//div[@class="m-lst36"]//li/a/text()').extract()

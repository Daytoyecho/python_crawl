...
# scrapy crawl country_laws_35


class CountryLaw35Spider(scrapy.Spider):
    name = 'country_laws_35'
    ...
    def start_requests(self):
        base = 'http://www.most.gov.cn/kjzc/gjkjzc/qyjsjb/index_{}.html'
        start_url = ['http://www.most.gov.cn/kjzc/gjkjzc/qyjsjb/']
    ...
    def parse_article(self, response):
        ...
        item["legalCategory"] = "科学技术部-国家科技政策企业技术进步与高新技术产业化"

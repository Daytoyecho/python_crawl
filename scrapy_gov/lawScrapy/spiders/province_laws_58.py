...
# scrapy crawl province_laws_58


class ProvinceLaw58Spider(scrapy.Spider):
    name = 'province_laws_58'
    allowed_domains = ['shandong.gov.cn']
    url_list = []
    count = 0

    def start_requests(self):
        base = "http://www.shandong.gov.cn/module/web/jpage/dataproxy.jsp?startrecord={}&endrecord={}&perpage=15&unitid=526386&webid=410&path=http://www.shandong.gov.cn/&webname=%E5%B1%B1%E4%B8%9C%E7%9C%81%E4%BA%BA%E6%B0%91%E6%94%BF%E5%BA%9C&col=1&columnid=107851&sourceContentType=1&permissiontype=0"
        start_url = ["http://www.shandong.gov.cn/module/web/jpage/dataproxy.jsp?startrecord=8146&endrecord=8155&perpage=15&unitid=526386&webid=410&path=http://www.shandong.gov.cn/&webname=%E5%B1%B1%E4%B8%9C%E7%9C%81%E4%BA%BA%E6%B0%91%E6%94%BF%E5%BA%9C&col=1&columnid=107851&sourceContentType=1&permissiontype=0"]

        for i in range(181):
            start_url.append(base.format(str(i*45+1), str((i+1)*45)))

        baseform = "col=1&webid=410&path=http%3A%2F%2Fwww.shandong.gov.cn%2F&columnid=107851&sourceContentType=1&unitid=526386&webname=%25E5%25B1%25B1%25E4%25B8%259C%25E7%259C%2581%25E4%25BA%25BA%25E6%25B0%2591%25E6%2594%25BF%25E5%25BA%259C&permissiontype=0"
        header = deepcopy(tools.header)
        header['Referer'] = 'http://www.shandong.gov.cn/col/col107851/index.html?uid=526386&pageNum=3'
    ...
    def parse_article(self, response):
        ...
        item["legalCategory"] = "山东省政府-地方性法规"

...
# scrapy crawl country_laws_37


class CountryLaw37Spider(scrapy.Spider):
    name = 'country_laws_37'
    ...
    def start_requests(self):
        base = 'http://www.most.gov.cn/kjzc/gjkjzc/kjrc/index_{}.html'
        start_url = ['http://www.most.gov.cn/kjzc/gjkjzc/kjrc/']
    ...
    def parse_article(self, response):
        ...
        item["legalCategory"] = "科学技术部-国家科技政策科技人才"

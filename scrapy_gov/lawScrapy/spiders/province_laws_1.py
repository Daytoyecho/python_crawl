...
# scrapy crawl province_laws_1


class ProvinceLaw1Spider(scrapy.Spider):
    name = 'province_laws_1'
    allowed_domains = ['beijing.gov.cn']
    url_list = []
    count = 0

    def start_requests(self):
        base1 = 'http://www.beijing.gov.cn/zhengce/zfwj/zfwj/szfwj/index_{}.html'
        base2 = 'http://www.beijing.gov.cn/zhengce/zfwj/zfwj2016/szfwj/index_{}.html'
        start_url = ['http://www.beijing.gov.cn/zhengce/zfwj/zfwj/szfwj/', 'http://www.beijing.gov.cn/zhengce/zfwj/zfwj2016/szfwj/']
    ...
    def parse_article(self, response):
        ...
        item["legalCategory"] = "北京市政府-市政府文件"

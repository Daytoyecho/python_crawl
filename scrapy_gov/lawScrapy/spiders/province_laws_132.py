...
# scrapy crawl province_laws_132


class ProvinceLaw132Spider(scrapy.Spider):
    name = 'province_laws_132'
    ...
    def start_requests(self):
        ...
        start_url = 'https://www.nanning.gov.cn/zwgk/fdzdgknr/zcwj/zfwj/qtwj1/index.html?page={}'

...
# scrapy crawl province_laws_102_1


class ProvinceLaw102Spider(scrapy.Spider):
    name = 'province_laws_102_1'
    ...
    def parse_article(self, response):
        ...
        if tools.isWeb(response.url):
            ...
            content = response.xpath('//div[@class="rm_txt_con cf"]').extract_first()
            fujian = response.xpath('//div[@class="rm_txt_con cf"]//a/@href').extract()
            fujian_name = response.xpath('//div[@class="rm_txt_con cf"]//a[@href]').xpath('string(.)').extract()

...
# scrapy crawl country_laws_39


class CountryLaw39Spider(scrapy.Spider):
    name = 'country_laws_39'
    ...
    def start_requests(self):
        base = 'http://www.most.gov.cn/kjzc/gjkjzc/kjtjybz/index_{}.html'
        start_url = ['http://www.most.gov.cn/kjzc/gjkjzc/kjtjybz/']
    ...
    def parse_article(self, response):
        ...
        item["legalCategory"] = "科学技术部-国家科技政策科技条件与标准"

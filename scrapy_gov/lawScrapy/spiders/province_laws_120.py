...
# scrapy crawl province_laws_120


class ProvinceLaw120Spider(scrapy.Spider):
    name = 'province_laws_120'
    ...
    def start_requests(self):
        ...
        start_url = ["http://jxf.jiangxi.gov.cn/module/web/jpage/dataproxy.jsp?startrecord=1&endrecord=161&perpage=161"]

        res = appbk_sql.mysql_com('SELECT legalUrl FROM `law`; ')
        self.url_list = [item['legalUrl'] for item in res]

        baseform = "col=1&webid=230&path=http%3A%2F%2Fjxf.jiangxi.gov.cn%2F&columnid=39217&sourceContentType=1&unitid=375746&webname=%E6%B1%9F%E8%A5%BF%E7%9C%81%E8%B4%A2%E6%94%BF%E5%8E%85&permissiontype=0"
        header = deepcopy(tools.header)
        header['Origin'] = 'http://jxf.jiangxi.gov.cn'
        header['Referer'] = 'http://jxf.jiangxi.gov.cn/col/col39217/index.html?uid=375746&pageNum=1'
    ...
    def parse_article(self, response):
        ...
        item["legalCategory"] = "江西省财政厅-政策解读"

...
# scrapy crawl country_laws_81


class CountryLaw81Spider(scrapy.Spider):
    name = 'country_laws_81'
    ...
    def start_requests(self):
        ...
        base = 'https://www.mee.gov.cn/zcwj/gwywj/index_{}.shtml'
        start_url = ['https://www.mee.gov.cn/zcwj/gwywj/index.shtml']
    ...
    def parse_article(self, response):
        ...
        item["legalCategory"] = "中华人民共和国生态环境部-政策文件-国务院有关文件"

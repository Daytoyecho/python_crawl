...
# scrapy crawl province_laws_75


class ProvinceLaw75Spider(scrapy.Spider):
    name = 'province_laws_75'
    ...
    def start_requests(self):
        ...
        with open("lawScrapy/spiders/p75.txt", 'r', encoding="utf-8") as f:
            text = f.read()
    ...
    def parse_article(self, response):
        ...
        item["legalCategory"] = "安徽省地方金融监督管理局-本级文件"

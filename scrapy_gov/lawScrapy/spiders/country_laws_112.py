...
# scrapy crawl country_laws_112


class CountryLaw112Spider(scrapy.Spider):
    name = 'country_laws_112'
    ...
    def start_requests(self):
        ...
        with open("lawScrapy/spiders/c112.json", 'r', encoding="utf-8") as f:
            data = json.load(f)
    ...
    def parse_article(self, response):
        ...
        item["legalCategory"] = "深交所-本所业务指南-会员交易类"

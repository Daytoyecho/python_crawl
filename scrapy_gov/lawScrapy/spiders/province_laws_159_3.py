...
class ProvinceLaw159_3Spider(scrapy.Spider):
    name = 'province_laws_159_3'
    ...
    def start_requests(self):
        ...
        base = "http://www.yinchuan.gov.cn/xxgk/zcwj/qtzfwj/bmwj_7733/gbmzxwj_{}.html"
        start_url = ['http://www.yinchuan.gov.cn/xxgk/zcwj/qtzfwj/bmwj_7733/gbmzxwj.html']
        for i in range(1, 50):

...
# scrapy crawl country_laws_78


class CountryLaw78Spider(scrapy.Spider):
    name = 'country_laws_78'
    ...
    def start_requests(self):
        ...
        base = 'https://www.mee.gov.cn/zcwj/bwj/gg/index_{}.shtml'
        start_url = ['https://www.mee.gov.cn/zcwj/bwj/gg/index.shtml']
    ...
    def parse_article(self, response):
        ...
        item["legalCategory"] = "中华人民共和国生态环境部-政策文件-部文件-公告"

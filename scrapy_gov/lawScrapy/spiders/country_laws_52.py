...
# scrapy crawl country_laws_52


class CountryLaw52Spider(scrapy.Spider):
    name = 'country_laws_52'
    allowed_domains = ['mof.gov.cn']
    url_list = []
    count = 0

    def start_requests(self):
        BASEURL = 'http://www.mof.gov.cn/zhengwuxinxi/zhengcefabu/index_{}.htm'
        start_url = ['http://www.mof.gov.cn/zhengwuxinxi/zhengcefabu/index.htm']

...
# scrapy crawl country_laws_84


class CountryLaw84Spider(scrapy.Spider):
    name = 'country_laws_84'
    ...
    def start_requests(self):
        ...
        base = 'https://www.mee.gov.cn/zcwj/xzspwj/index_{}.shtml'
        start_url = ['https://www.mee.gov.cn/zcwj/xzspwj/index.shtml']
    ...
    def parse_article(self, response):
        ...
        item["legalCategory"] = "中华人民共和国生态环境部-政策文件-行政审批文件"

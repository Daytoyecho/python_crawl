...
# scrapy crawl country_laws_13


class CountryLaw13Spider(scrapy.Spider):
    name = 'country_laws_13'
    allowed_domains = ['ndrc.gov.cn']
    url_list = []
    count = 0

    def start_requests(self):
        base = 'https://www.ndrc.gov.cn/xxgk/zcfb/gg/index_{}.html'
        start_url = ['https://www.ndrc.gov.cn/xxgk/zcfb/gg/index.html']
    ...
    def parse_article(self, response):
        ...
        if re.search(r"\((发.*[0-9]{4}.*)\)", item["legalPolicyName"]):
            ...
            item["legalDocumentNumber"] = "中华人民共和国国家发展和改革委员会公告" + re.search(r"(第[0-9]+号)", item["legalPolicyName"]).group(1)

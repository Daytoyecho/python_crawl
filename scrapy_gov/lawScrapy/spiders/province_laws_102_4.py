...
# scrapy crawl province_laws_102_4


# 这种的都拿不到 包括 “民法宣传挂图”、“ 中国银保监会有关部门负责人就《融资租赁公司非现场监管规程》答记者问 ”、“ 【权威发布】民法典公益宣传片来了 ”


class ProvinceLaw102Spider(scrapy.Spider):
    name = 'province_laws_102_4'
    ...
    def start_requests(self):
        # 只有一页
        start_url = ['http://jrjgj.xinjiang.gov.cn/jrb/zcjd/list.shtml']
    ...
    def parse_article(self, response):
        ...
        item["legalCategory"] = "新疆维吾尔自治区地方金融监督管理局-政策解读"
        ...
        if tools.isWeb(response.url):
            ...
            content = response.xpath('//*[@id="img-content"]').extract_first()
            fujian = response.xpath('//*[@id="img-content"]//a/@href').extract()
            fujian_name = response.xpath('//*[@id="img-content"]//a[@href]').xpath('string(.)').extract()

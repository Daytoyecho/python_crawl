...
# scrapy crawl province_laws_147


class ProvinceLaw147Spider(scrapy.Spider):
    name = 'province_laws_147'
    ...
    def start_requests(self):
        ...
        base = "http://www.gzrd.gov.cn/dffg/szdffg/index_{}.shtml"
        start_url = ['http://www.gzrd.gov.cn/dffg/szdffg/index.shtml']
    ...
    def parse_article(self, response):
        ...
        item["legalCategory"] = "贵州省政府-市州地方性法规"

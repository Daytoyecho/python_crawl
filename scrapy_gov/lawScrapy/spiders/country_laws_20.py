...
# scrapy crawl country_laws_20


class CountryLaw20Spider(scrapy.Spider):
    name = 'country_laws_20'
    ...
    def start_requests(self):
        base = 'http://www.most.gov.cn/satp/kjzc/kjjhgl/index_{}.html'
        start_url = ['http://www.most.gov.cn/satp/kjzc/kjjhgl/']
    ...
    def parse_dictionary(self, response):
        ...
        for i in range(len(law_url_list)):
            ...
            if "/publish/portal0/tab475/info70234.htm" in tmpurl:
                tmpurl = tmpurl.replace("http://www.nsfc", "https://www.nsfc")
            self.count += 1
            print(self.count)
    ...
    def parse_article(self, response):
        ...
        item["legalCategory"] = "科学技术部-科技政策科技计划管理"

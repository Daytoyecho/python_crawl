...
# scrapy crawl province_laws_89


class ProvinceLaw89Spider(scrapy.Spider):
    name = 'province_laws_89'
...
#-------------------------------------------------------------#
    ...
    def start_requests(self):
        ...
        base = 'http://www.ln.gov.cn/zwgkx/zcjd/index_{}.html'
        start_url = ['http://www.ln.gov.cn/zwgkx/zcjd/index.html']
    ...
    def parse_dictionary(self, response):
        ...
        law_url_list = response.xpath('//ul[@class="dlist_rul"]//li/a/@href').extract()
        law_title = response.xpath('//ul[@class="dlist_rul"]//li/a/@title').extract()
        law_time = response.xpath('//span[@class="dong_date"]/text()').extract()

...
# scrapy crawl province_laws_8


class ProvinceLaw8Spider(scrapy.Spider):
    name = 'province_laws_8'
    ...
    def start_requests(self):
        ...
        start_url = ['http://kw.beijing.gov.cn/col/col2388/index.html']
    ...
    def parse_article(self, response):
        ...
        item["legalCategory"] = "北京市科学技术委员会-北京市其他科技政策"

...
# scrapy crawl province_laws_46


class ProvinceLaw46Spider(scrapy.Spider):
    name = 'province_laws_46'
    allowed_domains = ['hangzhou.gov.cn']
    url_list = []
    count = 0

    def start_requests(self):
        start_url = ["http://www.hangzhou.gov.cn/module/jpage/dataproxy.jsp?startrecord=1&endrecord=150&perpage=50",
                     "http://www.hangzhou.gov.cn/module/jpage/dataproxy.jsp?startrecord=151&endrecord=300&perpage=50",
                     "http://www.hangzhou.gov.cn/module/jpage/dataproxy.jsp?startrecord=301&endrecord=450&perpage=50",
                     "http://www.hangzhou.gov.cn/module/jpage/dataproxy.jsp?startrecord=451&endrecord=600&perpage=50",
                     "http://www.hangzhou.gov.cn/module/jpage/dataproxy.jsp?startrecord=601&endrecord=672&perpage=24"]

        baseform = 'col=1&appid=1&webid=149&path=%2F&columnid=1229063383&sourceContentType=1&unitid=6793088&webname=%E6%9D%AD%E5%B7%9E%E5%B8%82%E4%BA%BA%E6%B0%91%E6%94%BF%E5%BA%9C%E9%97%A8%E6%88%B7%E7%BD%91%E7%AB%99&permissiontype=0'
        header = deepcopy(tools.header)
        header['Origin'] = 'http://www.hangzhou.gov.cn'
        header['Referer'] = 'http://www.hangzhou.gov.cn/col/col1229063383/index.html?uid=6793088&pageNum=1'
    ...
    def parse_article(self, response):
        ...
        item["legalCategory"] = "杭州市政府-部门行政规范性文件"

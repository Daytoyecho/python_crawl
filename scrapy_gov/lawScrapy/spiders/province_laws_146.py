...
# scrapy crawl province_laws_146


class ProvinceLaw146Spider(scrapy.Spider):
    name = 'province_laws_146'
    ...
    def start_requests(self):
        ...
        base = "http://www.gzrd.gov.cn/dffg/gzsdffg/index_{}.shtml"
        start_url = ['http://www.gzrd.gov.cn/dffg/gzsdffg/index_14.shtml']
    ...
    def parse_article(self, response):
        ...
        item["legalCategory"] = "贵州省政府-省地方性法规"

...
# scrapy crawl province_laws_63


class ProvinceLaw63Spider(scrapy.Spider):
    name = 'province_laws_63'
    ...
    def start_requests(self):
        ...
        start_url = "http://www.csrc.gov.cn/searchList/7a2daa6970f44284a6c628cd848f4a26?_isAgg=true&_isJson=true&_pageSize=10&_template=index&_rangeTimeGte=&_channelName=&page={}"

        header = deepcopy(tools.header)
        header['Referer'] = 'http://www.csrc.gov.cn/shandong/c104211/zfxxgk_zdgk.shtml?channelid=7a2daa6970f44284a6c628cd848f4a26'
    ...
    def parse_dictionary(self, response):
        ...
        for item in data['data']['results']:
            tmpurl = item['url']
            tmpurl = tools.getpath(tmpurl, "http://www.csrc.gov.cn/shandong/c104211/zfxxgk_zdgk.shtml")
    ...
    def parse_article(self, response):
        ...
        item["legalCategory"] = "中国证券监督管理委员会山东监管局-通知公告"

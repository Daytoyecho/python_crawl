...
# scrapy crawl province_laws_31


class ProvinceLaw31Spider(scrapy.Spider):
    name = 'province_laws_31'
    allowed_domains = ['gz.gov.cn']
    url_list = []
    count = 0

    def start_requests(self):
        base = "http://jrjgj.gz.gov.cn/zwgk/xxgk/xxgkml/qtwj/index_{}.html"
        start_url = ["http://jrjgj.gz.gov.cn/zwgk/xxgk/xxgkml/qtwj/index.html"]
    ...
    def parse_article(self, response):
        ...
        item["legalCategory"] = "广州市地方金融监督管理局-其他文件"

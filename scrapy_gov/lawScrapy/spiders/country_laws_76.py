...
# scrapy crawl country_laws_76


class CountryLaw76Spider(scrapy.Spider):
    name = 'country_laws_76'
    ...
    def start_requests(self):
        ...
        base = 'https://www.mee.gov.cn/zcwj/qt/lhfw/index_{}.shtml'
        start_url = ['https://www.mee.gov.cn/zcwj/qt/lhfw/index.shtml']
    ...
    def parse_article(self, response):
        ...
        item["legalCategory"] = "中华人民共和国生态环境部-政策文件-其他-联合发文"

...
# scrapy crawl province_laws_52


class ProvinceLaw52Spider(scrapy.Spider):
    name = 'province_laws_52'
    ...
    def start_requests(self):
        ...
        baseform = 'infotypeId=0801&jdid=39&area=&divid=div125&vc_title=&vc_number=&currpage={}&vc_filenumber=&vc_all=&texttype=&fbtime=&texttype=&fbtime=&vc_all=&vc_filenumber=&vc_title=&vc_number=&currpage={}&sortfield=&fields=&fieldConfigId=&hasNoPages=&infoCount='
        header = deepcopy(tools.header)
        header['Referer'] = 'http://jsgzw.jiangsu.gov.cn/col/col59225/index.html?number=0801'
    ...
    def parse_article(self, response):
        ...
        item["legalCategory"] = "江苏省人民政府国有资产监督管理委员会-法律法规规章"

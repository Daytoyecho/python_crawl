...
# scrapy crawl country_laws_54


class CountryLaw54Spider(scrapy.Spider):
    name = 'country_laws_54'
    ...
    def start_requests(self):
        BASEURL = 'http://www.mof.gov.cn/zhengwuxinxi/zhengcejiedu/index_{}.htm'
        start_url = ['http://www.mof.gov.cn/zhengwuxinxi/zhengcejiedu/index.htm']

...
# scrapy crawl country_laws_116


class CountryLaw116Spider(scrapy.Spider):
    name = 'country_laws_116'
    ...
    def start_requests(self):
        ...
        base = 'http://www.chinaclear.cn/zdjs/wczsc/service_flist_{}.shtml'
        start_url = ['http://www.chinaclear.cn/zdjs/wczsc/service_flist.shtml']
    ...
    def parse_article(self, response):
        ...
        item["legalCategory"] = "中国结算-服务支持-操作手册"

...
# scrapy crawl province_laws_29


class ProvinceLaw29Spider(scrapy.Spider):
    name = 'province_laws_29'
    allowed_domains = ['sz.gov.cn']
    url_list = []
    count = 0

    def start_requests(self):
        start_url = ["http://jr.sz.gov.cn/gkmlpt/api/all/2812?page=1&sid=755031"]
    ...
    def parse_article(self, response):
        ...
        item["legalCategory"] = "深圳市地方金融监督管理局-政策解读"

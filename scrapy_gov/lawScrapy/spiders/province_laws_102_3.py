...
# scrapy crawl province_laws_102_3


class ProvinceLaw102Spider(scrapy.Spider):
    name = 'province_laws_102_3'
    ...
    def parse_article(self, response):
        ...
        if tools.isWeb(response.url):
            ...
            content = response.xpath('//table[@class="tableblack"]').extract_first()
            fujian = response.xpath('//table[@class="tableblack"]//a/@href').extract()
            fujian_name = response.xpath('//table[@class="tableblack"]//a[@href]').xpath('string(.)').extract()

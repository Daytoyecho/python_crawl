...
# scrapy crawl country_laws_118


class CountryLaw118Spider(scrapy.Spider):
    name = 'country_laws_118'
    ...
    def start_requests(self):
        ...
        # 总共就两页
        start_url = ['http://www.chinaclear.cn/zdjs/wywbg/service_flist.shtml', 'http://www.chinaclear.cn/zdjs/wywbg/service_flist_2.shtml']
    ...
    def parse_article(self, response):
        ...
        item["legalCategory"] = "中国结算-服务支持-业务表格"

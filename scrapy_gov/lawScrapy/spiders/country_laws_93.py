...
# scrapy crawl country_laws_93


class CountryLaw93Spider(scrapy.Spider):
    name = 'country_laws_93'
    ...
    def start_requests(self):
        ...
        base = 'https://www.samr.gov.cn/zw/wjfb/zdjd/index_{}.html'
        start_url = ['https://www.samr.gov.cn/zw/wjfb/zdjd/index.html']
    ...
    def parse_article(self, response):
        ...
        item["legalCategory"] = "国家市场监督管理总局-政策解读"

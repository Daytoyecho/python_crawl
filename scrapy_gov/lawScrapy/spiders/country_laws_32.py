...
# scrapy crawl country_laws_32


class CountryLaw32Spider(scrapy.Spider):
    name = 'country_laws_32'
    ...
    def start_requests(self):
        start_url = ['http://www.most.gov.cn/kjzc/gjkjzc/kyjggg/']
    ...
    def parse_article(self, response):
        ...
        item["legalCategory"] = "科学技术部-国家科技政策科研机构改革"

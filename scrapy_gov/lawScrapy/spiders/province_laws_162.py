...
# scrapy crawl province_laws_162


class ProvinceLaw162Spider(scrapy.Spider):
    name = 'province_laws_162'
    ...
    def start_requests(self):
        ...
        base = "http://www.qinghai.gov.cn/xxgk/1/2/index_{}.html"
        start_url = ['http://www.qinghai.gov.cn/xxgk/1/2/index.html']

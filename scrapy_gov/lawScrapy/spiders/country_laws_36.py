...
# scrapy crawl country_laws_36


class CountryLaw36Spider(scrapy.Spider):
    name = 'country_laws_36'
    ...
    def start_requests(self):
        base = 'http://www.most.gov.cn/kjzc/gjkjzc/nckjyshfz/index_{}.html'
        start_url = ['http://www.most.gov.cn/kjzc/gjkjzc/nckjyshfz/']
    ...
    def parse_article(self, response):
        ...
        item["legalCategory"] = "科学技术部-国家科技政策农村科技与社会发展"

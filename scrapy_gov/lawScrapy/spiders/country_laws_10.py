...
# scrapy crawl country_laws_10


class CountryLaw10Spider(scrapy.Spider):
    name = 'country_laws_10'
    allowed_domains = ['ndrc.gov.cn']
    url_list = []
    count = 0

    def start_requests(self):
        base = 'https://www.ndrc.gov.cn/xxgk/jd/jd/index_{}.html'
        start_url = ['https://www.ndrc.gov.cn/xxgk/jd/jd/index.html']

...
# scrapy crawl country_laws_22


class CountryLaw22Spider(scrapy.Spider):
    name = 'country_laws_22'
    ...
    def start_requests(self):
        start_url = ['http://www.most.gov.cn/satp/kjzc/gjkjhz/']
    ...
    def parse_article(self, response):
        ...
        item["legalCategory"] = "科学技术部-科技政策国际科技合作"

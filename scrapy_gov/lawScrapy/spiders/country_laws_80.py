...
# scrapy crawl country_laws_80


class CountryLaw80Spider(scrapy.Spider):
    name = 'country_laws_80'
    ...
    def start_requests(self):
        ...
        base = 'https://www.mee.gov.cn/zcwj/zyygwj/index_{}.shtml'
        start_url = ['https://www.mee.gov.cn/zcwj/zyygwj/index.shtml']
    ...
    def parse_article(self, response):
        ...
        item["legalCategory"] = "中华人民共和国生态环境部-政策文件-中央有关文件"

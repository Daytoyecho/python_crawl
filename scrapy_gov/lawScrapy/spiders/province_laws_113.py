...
# scrapy crawl province_laws_113


class ProvinceLaw113Spider(scrapy.Spider):
    name = 'province_laws_113'
    ...
    def start_requests(self):
        ...
        base = "http://www.xa.gov.cn/gk/zcfg/szbf/list/{}.html"
        start_url = []

        for i in range(11, 129):

...
# scrapy crawl province_laws_72


class ProvinceLaw72Spider(scrapy.Spider):
    name = 'province_laws_72'
    ...
    def start_requests(self):
        ...
        base = "http://www.hunan.gov.cn/hnszf/xxgk/wjk/szfwj/wjk_glrb_{}.html"
        start_url = ['http://www.hunan.gov.cn/hnszf/xxgk/wjk/szfwj/wjk_glrb.html']
        for i in range(2, 34):
    ...
    def parse_article(self, response):
        ...
        item["legalCategory"] = "湖南省政府-省政府文件"

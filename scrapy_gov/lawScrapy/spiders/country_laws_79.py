...
# scrapy crawl country_laws_79


class CountryLaw79Spider(scrapy.Spider):
    name = 'country_laws_79'
    ...
    def start_requests(self):
        ...
        base = 'https://www.mee.gov.cn/zcwj/bwj/ling/index_{}.shtml'
        start_url = ['https://www.mee.gov.cn/zcwj/bwj/ling/index.shtml']
    ...
    def parse_article(self, response):
        ...
        item["legalCategory"] = "中华人民共和国生态环境部-政策文件-部文件-令"

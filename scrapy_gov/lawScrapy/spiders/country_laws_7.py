...
# scrapy crawl country_laws_7


class CountryLaw7Spider(scrapy.Spider):
    name = 'country_laws_7'
    ...
    def start_requests(self):
        base = 'https://www.ndrc.gov.cn/xxgk/zcfb/ghxwj/index_{}.html'
        start_url = ['https://www.ndrc.gov.cn/xxgk/zcfb/ghxwj/index.html']

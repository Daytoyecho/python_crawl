...
# scrapy crawl province_laws_114


class ProvinceLaw114Spider(scrapy.Spider):
    name = 'province_laws_114'
    ...
    def start_requests(self):
        ...
        base = "http://www.xa.gov.cn/gk/zcfg/szbh/list/{}.html"
        start_url = []

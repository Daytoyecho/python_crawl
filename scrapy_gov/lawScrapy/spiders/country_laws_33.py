...
# scrapy crawl country_laws_33


class CountryLaw33Spider(scrapy.Spider):
    name = 'country_laws_33'
    ...
    def start_requests(self):
        start_url = ['http://www.most.gov.cn/kjzc/gjkjzc/kjjfycw/']
    ...
    def parse_article(self, response):
        ...
        item["legalCategory"] = "科学技术部-国家科技政策科技经费与财务"

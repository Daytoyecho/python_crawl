...
# scrapy crawl country_laws_17


class CountryLaw17Spider(scrapy.Spider):
    name = 'country_laws_17'
    ...
    def start_requests(self):
        start_url = ['http://www.most.gov.cn/xxgk/xinxifenlei/fdzdgknr/fgzc/flfg/index.html', "http://www.most.gov.cn/xxgk/xinxifenlei/fdzdgknr/fgzc/flfg/index_1.html"]
    ...
    def parse_article(self, response):
        ...
        item["legalCategory"] = "科学技术部-法规政策法律法规"

...
# scrapy crawl country_laws_69


class CountryLaw69Spider(scrapy.Spider):
    name = 'country_laws_69'
    ...
    def start_requests(self):
        BASEURL = 'http://wzs.mofcom.gov.cn/article/n/?{}'
        start_url = ['http://wzs.mofcom.gov.cn/article/n/']
    ...
    def parse_dictionary(self, response):
        data_list = response.xpath('//*[@class="listCon f-mt30"]//li')
    ...
    def parse_article(self, response):
        ...
        item["legalCategory"] = "商务部-外资司政策发布"

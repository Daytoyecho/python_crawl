...
class ProvinceLaw159_2Spider(scrapy.Spider):
    name = 'province_laws_159_2'
    ...
    def start_requests(self):
        ...
        base = "http://www.yinchuan.gov.cn/xxgk/zcwj/qtzfwj/swbwj/index_{}.html"
        start_url = ['http://www.yinchuan.gov.cn/xxgk/zcwj/qtzfwj/swbwj/']
        for i in range(1, 61):

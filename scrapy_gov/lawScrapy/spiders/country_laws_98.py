...
class CountryLaw98Spider(scrapy.Spider):
    name = 'country_laws_98'
    allowed_domains = ['csrc.gov.cn']
    url_list = []
    count = 0

    def start_requests(self):
        start_url = 'http://www.csrc.gov.cn/searchList/625a2f95cc104c1d8b646f98d9f87470?_isAgg=true&_isJson=true&_pageSize=10&_template=index&_rangeTimeGte=&_channelName=&page={}'

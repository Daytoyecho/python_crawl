...
# scrapy crawl country_laws_111


class CountryLaw111Spider(scrapy.Spider):
    name = 'country_laws_111'
    ...
    def start_requests(self):
        ...
        with open("lawScrapy/spiders/c111.json", 'r', encoding="utf-8") as f:
            data = json.load(f)
    ...
    def parse_article(self, response):
        ...
        item["legalCategory"] = "深交所-本所业务指南-衍生类"

...
# scrapy crawl country_laws_41


class CountryLaw41Spider(scrapy.Spider):
    name = 'country_laws_41'
    ...
    def start_requests(self):
        base = 'http://www.most.gov.cn/kjzc/gjkjzc/kjcgyzscq/index_{}.html'
        start_url = ['http://www.most.gov.cn/kjzc/gjkjzc/kjcgyzscq/']
    ...
    def parse_article(self, response):
        ...
        item["legalCategory"] = "科学技术部-国家科技政策科技成果与知识产权"

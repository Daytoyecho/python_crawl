...
# scrapy crawl country_laws_24


class CountryLaw24Spider(scrapy.Spider):
    name = 'country_laws_24'
    ...
    def start_requests(self):
        base = 'http://www.most.gov.cn/satp/gjkjflfg/index_{}.html'
        start_url = ['http://www.most.gov.cn/satp/gjkjflfg/']
    ...
    def parse_article(self, response):
        ...
        item["legalCategory"] = "科学技术部-国家科技法律法规"

...
# scrapy crawl country_laws_75


class CountryLaw75Spider(scrapy.Spider):
    name = 'country_laws_75'
    allowed_domains = ['pbc.gov.cn']
    url_list = []
    count = 0

    def start_requests(self):
        base = 'http://www.pbc.gov.cn/jinrongshichangsi/147160/147171/147358/147400/22928/index{}.html'
        start_url = ['http://www.pbc.gov.cn/jinrongshichangsi/147160/147171/147358/147400/22928/index1.html']
    ...
    def parse_article(self, response):
        ...
        item["legalCategory"] = "中国人民银行-银行间债券市场政策法规"

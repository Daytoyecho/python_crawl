...
# scrapy crawl province_laws_108


class ProvinceLaw108Spider(scrapy.Spider):
    name = 'province_laws_108'
    ...
    def start_requests(self):
        ...
        base = "http://www.xa.gov.cn/gk/zcfg/gfxwj/{}.html"
        start_url = ['http://www.xa.gov.cn/gk/zcfg/gfxwj/1.html']
    ...
    def parse_article(self, response):
        ...
        item["legalCategory"] = "西安市政府-规范性文件"

...
# scrapy crawl province_laws_161_1


class ProvinceLaw161Spider(scrapy.Spider):
    name = 'province_laws_161_1'
    ...
    def start_requests(self):
        ...
        base = "http://www.qinghai.gov.cn/xxgk/xxgk/fd/lzyj/gfxwj/szf/index_{}.html"
        start_url = ['http://www.qinghai.gov.cn/xxgk/xxgk/fd/lzyj/gfxwj/szf/index.html']

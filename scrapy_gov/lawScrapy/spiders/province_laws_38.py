...
# scrapy crawl province_laws_38


class ProvinceLaw38Spider(scrapy.Spider):
    name = 'province_laws_38'
    ...
    def start_requests(self):
        ...
        baseform = "infotypeId=C0201&jdid=3096&area=&divid=div1229498488&vc_title=&vc_number=&sortfield=,compaltedate:0&currpage={}&vc_filenumber=&vc_all=&texttype=1&fbtime=-1&standardXxgk=0&isAllList=1&texttype=1&fbtime=-1&vc_all=&vc_filenumber=&vc_title=&vc_number=&currpage={}&sortfield=,compaltedate:0"
        header = deepcopy(tools.header)
        header['Origin'] = 'http://www.zj.gov.cn'
        header['Referer'] = 'http://www.zj.gov.cn/col/col1545742/index.html'
        header['Content-Type'] = 'application/x-www-form-urlencoded; charset=UTF-8'
        header['Cookie'] = "zh_choose_undefined=s; cssstyle=1; ZJYHZXSESSIONID=868061f1-6672-4277-b20c-df52b63f1ed5; SERVERID=b2ba659a0bf802d127f2ffc5234eeeba|1652798916|1652793586"
    ...
    def parse_article(self, response):
        ...
        item["legalCategory"] = "浙江省政府-其他文件-省政府"

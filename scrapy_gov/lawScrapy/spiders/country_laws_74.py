...
# scrapy crawl country_laws_74


class CountryLaw74Spider(scrapy.Spider):
    name = 'country_laws_74'
    allowed_domains = ['pbc.gov.cn']
    url_list = []
    count = 0

    def start_requests(self):
        start_url = 'http://www.pbc.gov.cn/jinrongshichangsi/147160/147171/147355/147383/index.html'
    ...
    def parse_article(self, response):
        ...
        item["legalCategory"] = "中国人民银行-货币市场政策法规"

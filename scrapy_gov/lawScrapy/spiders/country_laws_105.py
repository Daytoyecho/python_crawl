...
# scrapy crawl country_laws_105


class CountryLaw105Spider(scrapy.Spider):
    name = 'country_laws_105'
    ...
    def start_requests(self):
        ...
        with open("lawScrapy/spiders/c105.json", 'r', encoding="utf-8") as f:
            data = json.load(f)

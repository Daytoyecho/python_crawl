...
# scrapy crawl province_laws_56


class ProvinceLaw56Spider(scrapy.Spider):
    name = 'province_laws_56'
    allowed_domains = ['nanjing.gov.cn']
    url_list = []
    count = 0

    def start_requests(self):
        base = "https://www.nanjing.gov.cn/xxgkn/fggz/fg/index_{}.html"
        start_url = ["https://www.nanjing.gov.cn/xxgkn/fggz/fg/index.html"]

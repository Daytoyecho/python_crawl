...
# scrapy crawl province_laws_45


class ProvinceLaw45Spider(scrapy.Spider):
    name = 'province_laws_45'
    ...
    def start_requests(self):
        start_url = ["http://www.hangzhou.gov.cn/module/jpage/dataproxy.jsp?startrecord=1&endrecord=300&perpage=100",
                     "http://www.hangzhou.gov.cn/module/jpage/dataproxy.jsp?startrecord=301&endrecord=600&perpage=100",
                     "http://www.hangzhou.gov.cn/module/jpage/dataproxy.jsp?startrecord=601&endrecord=867&perpage=90"]

        baseform = 'col=1&appid=1&webid=149&path=%2F&columnid=1229063382&sourceContentType=1&unitid=7123791&webname=%E6%9D%AD%E5%B7%9E%E5%B8%82%E4%BA%BA%E6%B0%91%E6%94%BF%E5%BA%9C%E9%97%A8%E6%88%B7%E7%BD%91%E7%AB%99&permissiontype=0'
        header = deepcopy(tools.header)
        header['Origin'] = 'http://www.hangzhou.gov.cn'
        header['Referer'] = 'http://www.hangzhou.gov.cn/col/col1229063382/index.html?uid=7123791&pageNum=3'
    ...
    def parse_article(self, response):
        ...
        item["legalCategory"] = "杭州市政府-市政府办公厅行政规范性文件"

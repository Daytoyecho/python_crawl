...
# scrapy crawl province_laws_83


class ProvinceLaw83Spider(scrapy.Spider):
    name = 'province_laws_83'
    allowed_domains = ['wuhan.gov.cn']
    url_list = []
    count = 0

    def start_requests(self):
        base = "http://www.wuhan.gov.cn/zwgk/xxgk/zfwj/bgtwj/index_{}.shtml"
        start_url = ["http://www.wuhan.gov.cn/zwgk/xxgk/zfwj/bgtwj/index.shtml"]
    ...
    def parse_article(self, response):
        ...
        item["legalCategory"] = "武汉市政府-办公室文件"

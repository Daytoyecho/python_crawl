...
# scrapy crawl country_laws_27


class CountryLaw27Spider(scrapy.Spider):
    name = 'country_laws_27'
    ...
    def start_requests(self):
        base = 'https://fuwu.most.gov.cn/html/zcjd/index_{}.html'
        start_url = ['https://fuwu.most.gov.cn/html/zcjd/index.html']
    ...
    def parse_article(self, response):
        ...
        item["legalCategory"] = "科学技术部-政务服务政策解读"
